...
type DeviceStatus struct {
	...
	// SimPinState：ready / sim_pin / sim_puk / not_inserted / unknown
	SimPinState    string `json:"sim_pin_state,omitempty"`
	SimPinRequired bool   `json:"sim_pin_required,omitempty"`
	SimPinSaved    bool   `json:"sim_pin_saved,omitempty"`
}
